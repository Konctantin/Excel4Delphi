...
type
  ...
  public
    ...
    [Test]
    [TestCase('String to TDate 1', '12.10.2005 22:55:16')]
    [TestCase('String to TDate 2', '12-10-2005 22:55:16')]
    [TestCase('String to TDate 3', '12/10/2005 22:55:16')]
    //[TestCase('String to TDate 4', '38637,9550462963')]
    [TestCase('String to TDate 5', '38637.9550462963')]
    [TestCase('String to TDate 6', '2005-10-12T22:55:16')]
